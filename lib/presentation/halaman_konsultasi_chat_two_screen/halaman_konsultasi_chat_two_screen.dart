...
class HalamanKonsultasiChatTwoScreen extends StatelessWidget {HalamanKonsultasiChatTwoScreen({Key? key}) : super(key: key);

TextEditingController messageController = TextEditingController();

@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(resizeToAvoidBottomInset: false, appBar: _buildAppBar(context), body: SizedBox(width: SizeUtils.width, child: SingleChildScrollView(child: Container(height: 69.v, width: double.maxFinite, margin: EdgeInsets.only(bottom: 5.v)))), bottomNavigationBar: _buildMessage(context))); } 
/// Section Widget
